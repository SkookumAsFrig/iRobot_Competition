...
%
%   Output:
%           obstacles   n x 8 matrix consisting of all vertices of polygons
%
%   Final Competition
%   Kowin Shi, Jie Huang
...
for i = 1: size_map
    ...
    hold on
    for j = 1:4
        plot(obstacles(i,1:2:end),obstacles(i,2:2:end));
        plot([obstacles(i,1),obstacles(i,end-1)],[obstacles(i,2),obstacles(i,end)]);
        hold on
    end
end
