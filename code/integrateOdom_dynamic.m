function newstate = integrateOdom_dynamic(xi, yi, thetai, d, phi, noiseprofile)
...
noise = [normrnd(0,noiseprofile(1)); normrnd(0,noiseprofile(2)); normrnd(0,noiseprofile(3))];
